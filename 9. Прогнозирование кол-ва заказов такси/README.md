...
## Результат
Получена лучшая модель RandomForestRegressor() с оптимальными гиперпараметрами для прогнозирования кол-ва такси. Значение метрики RMSE для выбранной модели на тестовой выборке равно 43.
