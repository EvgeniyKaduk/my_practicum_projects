...
## Результат
В качестве оптимальной модели для определения возраста по фотографии мы использовали предобученную сверточную нейронную сеть ResNet50, которая обучается в пределах 20 минут и дает на тествой выборке метрику качества MAE=6.1.
